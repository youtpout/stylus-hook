...
contract DeployHookScript is Script {
    ...
    address stylusHook = address(0x2b0E3FE41CA17385d48C30A07764f56aD5249349);
    ...
    function run() external {
        ...
        IERC20(token0).approve(address(lpRouter), 100000e18);
        IERC20(token1).approve(address(lpRouter), 100000e18);
        IERC20(token0).approve(address(swapRouter), 100000e18);
        IERC20(token1).approve(address(swapRouter), 100000e18);
