...
// Vendored unmodified except for this note, from ABDK's library as carried by Uniswap's v4-periphery
// TWAMM example hook. Kept under its own BSD-4-Clause terms; the rest of this repository is MIT.
//
// It is here to be measured, not used: it implements IEEE 754 binary128 in software because the EVM
// has no floating point, which is exactly the cost `bench-twamm.bash` is about.
