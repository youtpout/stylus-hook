...
export interface AddLiquidityScriptInterface extends Interface {
...
export interface AddLiquidityScript extends BaseContract {
  connect(runner?: ContractRunner | null): AddLiquidityScript;
  waitForDeployment(): Promise<this>;

  interface: AddLiquidityScriptInterface;
