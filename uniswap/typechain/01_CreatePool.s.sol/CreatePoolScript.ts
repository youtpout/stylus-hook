...
export interface CreatePoolScriptInterface extends Interface {
...
export interface CreatePoolScript extends BaseContract {
  connect(runner?: ContractRunner | null): CreatePoolScript;
  waitForDeployment(): Promise<this>;

  interface: CreatePoolScriptInterface;
