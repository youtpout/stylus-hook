...
export interface PoolNestedActionsTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface PoolNestedActionsTest extends BaseContract {
  connect(runner?: ContractRunner | null): PoolNestedActionsTest;
  waitForDeployment(): Promise<this>;

  interface: PoolNestedActionsTestInterface;
  ...
  unlock: TypedContractMethod<[data: BytesLike], [void], "nonpayable">;
