...
export interface CounterProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "HOOK_PROXY"
      | "afterAddLiquidity"
  ...
  decodeFunctionResult(functionFragment: "HOOK_PROXY", data: BytesLike): Result;
...
export interface CounterProxy extends BaseContract {
  connect(runner?: ContractRunner | null): CounterProxy;
  waitForDeployment(): Promise<this>;

  interface: CounterProxyInterface;
  ...
  HOOK_PROXY: TypedContractMethod<[], [string], "view">;
