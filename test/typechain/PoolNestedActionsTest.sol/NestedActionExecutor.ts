...
export interface NestedActionExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface NestedActionExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): NestedActionExecutor;
  waitForDeployment(): Promise<this>;

  interface: NestedActionExecutorInterface;
  ...
  execute: TypedContractMethod<[actions: BigNumberish[]], [void], "nonpayable">;

  failed: TypedContractMethod<[], [boolean], "nonpayable">;

  manager: TypedContractMethod<[], [string], "view">;

  setKey: TypedContractMethod<[_key: PoolKeyStruct], [void], "nonpayable">;
  ...
  unlockCallback: TypedContractMethod<[arg0: BytesLike], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "setKey"
  ): TypedContractMethod<[_key: PoolKeyStruct], [void], "nonpayable">;
  getFunction(
