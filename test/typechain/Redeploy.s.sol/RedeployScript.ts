...
export interface RedeployScriptInterface extends Interface {
...
export interface RedeployScript extends BaseContract {
  connect(runner?: ContractRunner | null): RedeployScript;
  waitForDeployment(): Promise<this>;

  interface: RedeployScriptInterface;
