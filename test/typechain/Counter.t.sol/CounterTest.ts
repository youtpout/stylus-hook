...
export interface CounterTestInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "testCounterHooks",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testLiquidityHooks",
    values?: undefined
  ): string;
...
export interface CounterTest extends BaseContract {
  ...
  testCounterHooks: TypedContractMethod<[], [void], "nonpayable">;

  testLiquidityHooks: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testCounterHooks"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "testLiquidityHooks"
  ): TypedContractMethod<[], [void], "nonpayable">;
